...
class StudentCourseAdmin(admin.ModelAdmin):
    ...
    search_fields = ('student__name','course__name','student__class_id__id','student__class__id__dept__name')
            ...
            for single_date in daterange(start_date,end_date):
                if single_date.isoweekday() == days[asst.day]:
                    try:
                        ...
                        a = AttendanceClass(date=single_date.strftime("%Y-%m-%d"),assing=asst.assign)
                        a.save()
        self.message_user(request,'Attendance Dates reset succesfully!')
