...
from django.db.models.fields.json import ContainedBy, HasKeys
...
class Teacher(models.Model):
    user = models.OneToOneField(User,on_delete=models.CASCADE,null=True)
    id = models.CharField(primary_key=True,max_length=100)
    dept = models.CharField(Dept,on_delete=models.CASCADE)
...
#triggers -  bazaga ma'lumot kirishidan oldin tekshirib boradigan signallar
