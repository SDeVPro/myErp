...
class InfoTest(TestCase):
    ...
    def create_class(self,id='CSSA',sem=5,section='A'):
    ...
    def create_student(self,usn='CS01',name='Sardor'):
    ...
    def setUp(self):
        self.client = Client()
        self.user = User.objects.create_user('test_user','test@mail.com','test_password')
