...
urlpatterns = [
    ...
    path('teacher/<int:assing_id>/Students/attendance/',views.t_student,name='t_student'),
    path('teacher/<int:ass_c_id>/ClassDates/',views.t_class_date,name='t_class_date'),
    ...
    path('teacher/<slug:assign_id>/Extra_class/',views.t_extra_class,name='t_extra_class'),
    ...
    path('teacher/<slug:teacher_id>/t_timetable/',views.timetable,name='t_timetable'),
